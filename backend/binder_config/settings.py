...
# Import schema settings from factory_code_schema.py
# from inventory_management.schema import SPECTACULAR_SETTINGS_EXTENSION
# SPECTACULAR_SETTINGS = SPECTACULAR_SETTINGS_EXTENSION
...
DATABASE_URL = os.getenv(
    'DATABASE_URL',
    'postgresql://binderserverdb_user:CTuzyMDEHXn5LB48QXkhqe9Lxvg7F0LF@dpg-d6gsvr9aae7s73bjp480-a.oregon-postgres.render.com/binderserverdb'
)
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Binder ERP - Factory Code API',
    'DESCRIPTION': 'Factory Code Module API for Textile Manufacturing',
    'VERSION': '2.0.0',
